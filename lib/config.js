...
export const RUN_DIR = join(homedir(), 'Library', 'Application Support', 'web-plane', 'run');
...
export const PATCH_MARKERS = [
  {
    ...
    marker: 'web-plane: DYLD injection',
  ...
  },
  {
    ...
    marker: 'web-plane: transition from DYLD',
    what: 'hand the hidden window from the launch hook to CDP',
  },
];

// agent-browser below this version cannot keep two concurrent sessions pinned to
// different tabs of the same browser — they steal each other's active page.
export const MIN_AGENT_BROWSER = '0.33.0';
