...
export const PATCH_MARKERS = [
  ...
  },
  {
    ...
    marker: 'WEB_PLANE_PLAYWRIGHT_FOCUS_EMULATION',
    what: 'leave focus emulation to the lane monitor so idle tabs go hidden',
  },
  {
    file: 'node_modules/playwright-core/lib/server/chromium/chromiumSwitches.js',
    marker: 'AllowDevtoolsConnectedDiscard',
    what: 'let Memory Saver discard idle lane tabs despite the attached driver',
  },
];
...
// How long after its last command a lane keeps focus emulation. While held,
// Chrome treats the tab as captured and renders it at full rate; released,
// a background tab goes hidden and Chrome's own throttling stops the burn.
export const LANE_FOCUS_IDLE_MS = positiveDuration(
  'WEB_PLANE_LANE_FOCUS_IDLE_MS',
  5 * 60 * 1000
);
