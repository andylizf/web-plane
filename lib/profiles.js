...
export function profiles() {
  ...
  console.log(
    `\nLOGGED INTO is evidence, not a verdict — a host is listed when this profile\n` +
      `holds a cookie that looks like a durable session for it. Read a missing host as\n` +
